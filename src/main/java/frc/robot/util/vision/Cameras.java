...
/**
 * Camera Enum to select each camera. Imported from YAGSL to ensure consistency with test results.
 */
public enum Cameras {
     ...
     * Center Camera
     */
    CENTER_CAM(VisionOdometryConstants.CENTER_CAMERA_NAME,
        VisionOdometryConstants.CENTER_CAMERA_ROTATION,
    ...
    Cameras(String name, Rotation3d robotToCamRotation, Translation3d robotToCamTranslation,
        ...
        poseEstimator = new PhotonPoseEstimator(PhotonVisionOdometry.fieldLayout,
